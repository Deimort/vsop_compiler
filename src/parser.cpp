...
#line 96 "parser.y"
                    {
                        ...
                        {
                            error(yystack_[0].location, "variable " + yystack_[0].value.as < std::string > () + " not defined");
                            YYERROR;
                        }
                        yylhs.value.as < int > () = driver.get_variable(yystack_[0].value.as < std::string > ());
                    }
#line 621 "parser.cpp"
    break;
...
#line 655 "parser.cpp"
  ...
  Parser::yypact_[] =
  {
      -5,     5,     4,    -5,     6,    10,    -5,    -5,    17,    -5,
      -3,     6,     6,     6,     6,     6,    -5,    17,     9,     9,
      -5,    -5
  };
  ...
  Parser::yystos_[] =
  {
       0,    16,    17,     0,     8,    13,    14,    18,    19,    13,
      19,     3,     4,     5,     6,     7,     9,    19,    19,    19,
      19,    19
  };
  ...
  Parser::yyrline_[] =
  {
       0,    85,    85,    88,    89,    92,    95,    96,   104,   105,
     106,   107,   108
  };
