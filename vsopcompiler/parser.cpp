...
#line 149 "parser.y"
                   { yylhs.value.as < std::vector<std::shared_ptr<ClassNode>> > () = yystack_[0].value.as < std::vector<std::shared_ptr<ClassNode>> > (); driver.setProgram(yylhs.value.as < std::vector<std::shared_ptr<ClassNode>> > ()); }
#line 993 "parser.cpp"
    break;
...
#line 156 "parser.y"
                                    { yylhs.value.as < std::shared_ptr<ClassNode> > () = std::make_shared<ClassNode>(yystack_[1].value.as < std::string > (), yystack_[0].value.as < std::shared_ptr<ClassBodyNode> > ()); }
#line 1011 "parser.cpp"
    break;

  case 6: // class: "class" "type-identifier" "extends" "type-identifier" classBody
#line 157 "parser.y"
                                                              { yylhs.value.as < std::shared_ptr<ClassNode> > () = std::make_shared<ClassNode>(yystack_[3].value.as < std::string > (), yystack_[0].value.as < std::shared_ptr<ClassBodyNode> > (), yystack_[1].value.as < std::string > ()); }
...
#line 165 "parser.y"
             { yylhs.value.as < std::shared_ptr<ClassBodyNode> > () = std::make_shared<ClassBodyNode>(); }
#line 1041 "parser.cpp"
    break;

  case 11: // field: "object-identifier" ":" type ";"
#line 168 "parser.y"
                                           { yylhs.value.as < std::shared_ptr<FieldNode> > () = std::make_shared<FieldNode>(yystack_[3].value.as < std::string > (), yystack_[1].value.as < std::string > ()); }
#line 1047 "parser.cpp"
    break;

  case 12: // field: "object-identifier" ":" type "<-" expr ";"
#line 169 "parser.y"
                                                         { yylhs.value.as < std::shared_ptr<FieldNode> > () = std::make_shared<FieldNode>(yystack_[5].value.as < std::string > (), yystack_[3].value.as < std::string > (), yystack_[1].value.as < std::shared_ptr<ExprNode> > ()); }
#line 1053 "parser.cpp"
    break;

  case 13: // method: "object-identifier" "(" formals ")" ":" type block
#line 172 "parser.y"
                                                         { yylhs.value.as < std::shared_ptr<MethodNode> > () = std::make_shared<MethodNode>(yystack_[6].value.as < std::string > (), yystack_[4].value.as < std::vector<std::shared_ptr<FormalNode>> > (), yystack_[1].value.as < std::string > (), yystack_[0].value.as < std::shared_ptr<BlockNode> > ()); }
...
#line 182 "parser.y"
                         { yylhs.value.as < std::vector<std::shared_ptr<FormalNode>> > () = yystack_[0].value.as < std::vector<std::shared_ptr<FormalNode>> > (); yylhs.value.as < std::vector<std::shared_ptr<FormalNode>> > ().push_back(yystack_[2].value.as < std::shared_ptr<FormalNode> > ()); }
...
#line 187 "parser.y"
                                 { yylhs.value.as < std::shared_ptr<FormalNode> > () = std::make_shared<FormalNode>(yystack_[2].value.as < std::string > (), yystack_[0].value.as < std::string > ()); }
#line 1113 "parser.cpp"
    break;

  case 23: // block: "{" exprList "}"
#line 190 "parser.y"
                           { yylhs.value.as < std::shared_ptr<BlockNode> > () = std::make_shared<BlockNode>(yystack_[1].value.as < std::vector<std::shared_ptr<ExprNode>> > ()); }
...
#line 194 "parser.y"
                              { yylhs.value.as < std::vector<std::shared_ptr<ExprNode>> > () = yystack_[0].value.as < std::vector<std::shared_ptr<ExprNode>> > (); yylhs.value.as < std::vector<std::shared_ptr<ExprNode>> > ().push_back(yystack_[2].value.as < std::shared_ptr<ExprNode> > ()); }
...
#line 205 "parser.y"
                        { yylhs.value.as < std::shared_ptr<ExprNode> > () = std::make_shared<IdentifierNode>(yystack_[0].value.as < std::string > ()); }
#line 1185 "parser.cpp"
    break;

  case 35: // expr: "self"
#line 206 "parser.y"
           { yylhs.value.as < std::shared_ptr<ExprNode> > () = std::make_shared<SelfNode>(); }
...
#line 1197 "parser.cpp"
  ...
  case 37: // expr: "(" ")"
#line 208 "parser.y"
                { yylhs.value.as < std::shared_ptr<ExprNode> > () = std::make_shared<UnitNode>(); }
...
#line 218 "parser.y"
                      { yylhs.value.as < std::shared_ptr<IfNode> > () = std::make_shared<IfNode>(yystack_[2].value.as < std::shared_ptr<ExprNode> > (), yystack_[0].value.as < std::shared_ptr<ExprNode> > ()); }
#line 1239 "parser.cpp"
    break;

  case 44: // ifExpr: "if" expr "then" expr "else" expr
#line 219 "parser.y"
                                  { yylhs.value.as < std::shared_ptr<IfNode> > () = std::make_shared<IfNode>(yystack_[4].value.as < std::shared_ptr<ExprNode> > (), yystack_[2].value.as < std::shared_ptr<ExprNode> > (), yystack_[0].value.as < std::shared_ptr<ExprNode> > ()); }
#line 1245 "parser.cpp"
    break;

  case 45: // whileExpr: "while" expr "do" expr
#line 222 "parser.y"
                       { yylhs.value.as < std::shared_ptr<WhileNode> > () = std::make_shared<WhileNode>(yystack_[2].value.as < std::shared_ptr<ExprNode> > (), yystack_[0].value.as < std::shared_ptr<ExprNode> > ()); }
#line 1251 "parser.cpp"
    break;

  case 46: // letExpr: "let" "object-identifier" ":" type "in" expr
#line 225 "parser.y"
                                             { yylhs.value.as < std::shared_ptr<LetNode> > () = std::make_shared<LetNode>(yystack_[4].value.as < std::string > (), yystack_[2].value.as < std::string > (), yystack_[0].value.as < std::shared_ptr<ExprNode> > ()); }
#line 1257 "parser.cpp"
    break;

  case 47: // letExpr: "let" "object-identifier" ":" type "<-" expr "in" expr
#line 226 "parser.y"
                                                           { yylhs.value.as < std::shared_ptr<LetNode> > () = std::make_shared<LetNode>(yystack_[6].value.as < std::string > (), yystack_[4].value.as < std::string > (), yystack_[2].value.as < std::shared_ptr<ExprNode> > (), yystack_[0].value.as < std::shared_ptr<ExprNode> > ()); }
#line 1263 "parser.cpp"
    break;

  case 48: // assignExpr: "object-identifier" "<-" expr
#line 229 "parser.y"
                                  { yylhs.value.as < std::shared_ptr<AssignNode> > () = std::make_shared<AssignNode>(yystack_[2].value.as < std::string > (), yystack_[0].value.as < std::shared_ptr<ExprNode> > ()); }
#line 1269 "parser.cpp"
    break;

  case 49: // unOpExpr: "not" expr
#line 232 "parser.y"
             { yylhs.value.as < std::shared_ptr<UnOpNode> > () = std::make_shared<NotUnOpNode>(yystack_[0].value.as < std::shared_ptr<ExprNode> > ()); }
#line 1275 "parser.cpp"
    break;

  case 50: // unOpExpr: "-" expr
#line 233 "parser.y"
                                  { yylhs.value.as < std::shared_ptr<UnOpNode> > () = std::make_shared<MinusUnOpNode>(yystack_[0].value.as < std::shared_ptr<ExprNode> > ()); }
#line 1281 "parser.cpp"
    break;

  case 51: // unOpExpr: "isnull" expr
#line 234 "parser.y"
                  { yylhs.value.as < std::shared_ptr<UnOpNode> > () = std::make_shared<IsnullUnOpNode>(yystack_[0].value.as < std::shared_ptr<ExprNode> > ()); }
#line 1287 "parser.cpp"
    break;

  case 52: // binOpExpr: expr "=" expr
#line 237 "parser.y"
                    { yylhs.value.as < std::shared_ptr<BinOpNode> > () = std::make_shared<EqualBinOpNode>(yystack_[2].value.as < std::shared_ptr<ExprNode> > (), yystack_[0].value.as < std::shared_ptr<ExprNode> > ()); }
#line 1293 "parser.cpp"
    break;

  case 53: // binOpExpr: expr "<" expr
#line 238 "parser.y"
                      { yylhs.value.as < std::shared_ptr<BinOpNode> > () = std::make_shared<LowerBinOpNode>(yystack_[2].value.as < std::shared_ptr<ExprNode> > (), yystack_[0].value.as < std::shared_ptr<ExprNode> > ()); }
#line 1299 "parser.cpp"
    break;

  case 54: // binOpExpr: expr "<=" expr
#line 239 "parser.y"
                            { yylhs.value.as < std::shared_ptr<BinOpNode> > () = std::make_shared<LowerOrEqualBinOpNode>(yystack_[2].value.as < std::shared_ptr<ExprNode> > (), yystack_[0].value.as < std::shared_ptr<ExprNode> > ()); }
#line 1305 "parser.cpp"
    break;

  case 55: // binOpExpr: expr "+" expr
#line 240 "parser.y"
                     { yylhs.value.as < std::shared_ptr<BinOpNode> > () = std::make_shared<AddBinOpNode>(yystack_[2].value.as < std::shared_ptr<ExprNode> > (), yystack_[0].value.as < std::shared_ptr<ExprNode> > ()); }
#line 1311 "parser.cpp"
    break;

  case 56: // binOpExpr: expr "-" expr
#line 241 "parser.y"
                      { yylhs.value.as < std::shared_ptr<BinOpNode> > () = std::make_shared<MinusBinOpNode>(yystack_[2].value.as < std::shared_ptr<ExprNode> > (), yystack_[0].value.as < std::shared_ptr<ExprNode> > ()); }
#line 1317 "parser.cpp"
    break;

  case 57: // binOpExpr: expr "*" expr
#line 242 "parser.y"
                      { yylhs.value.as < std::shared_ptr<BinOpNode> > () = std::make_shared<MulBinOpNode>(yystack_[2].value.as < std::shared_ptr<ExprNode> > (), yystack_[0].value.as < std::shared_ptr<ExprNode> > ()); }
#line 1323 "parser.cpp"
    break;

  case 58: // binOpExpr: expr "/" expr
#line 243 "parser.y"
                    { yylhs.value.as < std::shared_ptr<BinOpNode> > () = std::make_shared<DivBinOpNode>(yystack_[2].value.as < std::shared_ptr<ExprNode> > (), yystack_[0].value.as < std::shared_ptr<ExprNode> > ()); }
#line 1329 "parser.cpp"
    break;

  case 59: // binOpExpr: expr "^" expr
#line 244 "parser.y"
                    { yylhs.value.as < std::shared_ptr<BinOpNode> > () = std::make_shared<PowBinOpNode>(yystack_[2].value.as < std::shared_ptr<ExprNode> > (), yystack_[0].value.as < std::shared_ptr<ExprNode> > ()); }
#line 1335 "parser.cpp"
    break;

  case 60: // binOpExpr: expr "and" expr
#line 245 "parser.y"
                    { yylhs.value.as < std::shared_ptr<BinOpNode> > () = std::make_shared<AndBinOpNode>(yystack_[2].value.as < std::shared_ptr<ExprNode> > (), yystack_[0].value.as < std::shared_ptr<ExprNode> > ()); }
#line 1341 "parser.cpp"
    break;

  case 61: // callExpr: "object-identifier" "(" args ")"
#line 248 "parser.y"
                                     { yylhs.value.as < std::shared_ptr<CallNode> > () = std::make_shared<CallNode>(yystack_[3].value.as < std::string > (), yystack_[1].value.as < std::vector<std::shared_ptr<ExprNode>> > ()); }
#line 1347 "parser.cpp"
    break;

  case 62: // callExpr: expr "." "object-identifier" "(" args ")"
#line 249 "parser.y"
                                                { yylhs.value.as < std::shared_ptr<CallNode> > () = std::make_shared<CallNode>(yystack_[3].value.as < std::string > (), yystack_[1].value.as < std::vector<std::shared_ptr<ExprNode>> > (), yystack_[5].value.as < std::shared_ptr<ExprNode> > ()); }
#line 1353 "parser.cpp"
    break;

  case 63: // newExpr: "new" "type-identifier"
#line 252 "parser.y"
                        { yylhs.value.as < std::shared_ptr<NewNode> > () = std::make_shared<NewNode>(yystack_[0].value.as < std::string > ());}
#line 1359 "parser.cpp"
    break;

  case 64: // literal: "integer-literal"
#line 255 "parser.y"
                    { yylhs.value.as < std::shared_ptr<LiteralNode> > () = std::make_shared<LiteralNode>(std::to_string(yystack_[0].value.as < int > ())); }
#line 1365 "parser.cpp"
    break;

  case 65: // literal: "string-literal"
#line 256 "parser.y"
                     { yylhs.value.as < std::shared_ptr<LiteralNode> > () = std::make_shared<LiteralNode>(yystack_[0].value.as < std::string > ()); }
...
#line 260 "parser.y"
         { yylhs.value.as < std::shared_ptr<LiteralNode> > () = std::make_shared<LiteralNode>("true"); }
#line 1383 "parser.cpp"
    break;

  case 68: // booleanLiteral: "false"
#line 261 "parser.y"
            { yylhs.value.as < std::shared_ptr<LiteralNode> > () = std::make_shared<LiteralNode>("false"); }
...
#line 1393 "parser.cpp"
  ...
  Parser::yyrline_[] =
  {
       0,   149,   149,   152,   153,   156,   157,   160,   163,   164,
     165,   168,   169,   172,   175,   176,   177,   178,   179,   182,
     183,   184,   187,   190,   193,   194,   197,   198,   199,   200,
     201,   202,   203,   204,   205,   206,   207,   208,   209,   210,
     213,   214,   215,   218,   219,   222,   225,   226,   229,   232,
     233,   234,   237,   238,   239,   240,   241,   242,   243,   244,
     245,   248,   249,   252,   255,   256,   257,   260,   261
  };
