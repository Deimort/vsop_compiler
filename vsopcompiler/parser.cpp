...
#line 227 "parser.y"
                                                           { yylhs.value.as < std::shared_ptr<LetNode> > () = std::make_shared<LetNode>(yystack_[6].value.as < std::string > (), yystack_[4].value.as < std::string > (), yystack_[0].value.as < std::shared_ptr<ExprNode> > (), yystack_[2].value.as < std::shared_ptr<ExprNode> > ()); }
